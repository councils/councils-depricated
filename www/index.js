...
})(this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_113__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	'ionic.service.analytics', 'ngCordova', __webpack_require__(7)(angular).name, __webpack_require__(11)(angular).name, __webpack_require__(18)(angular).name, __webpack_require__(23)(angular).name, __webpack_require__(82)(angular).name, __webpack_require__(87)(angular).name, __webpack_require__(92)(angular).name, __webpack_require__(99)(angular).name, __webpack_require__(104)(angular).name]).constant('version', __webpack_require__(112).version).constant('_', __webpack_require__(113)).config(["$compileProvider", "$urlRouterProvider", "$mdThemingProvider", "$ionicAppProvider", function ($compileProvider, $urlRouterProvider, $mdThemingProvider, $ionicAppProvider) {
	...
	}]).run(["$log", "$rootScope", "$ionicBackdrop", "$timeout", "User", "$window", "$mdUtil", "$mdSidenav", "$state", "Auth", "$mdDialog", "$ionicUser", "$ionicPush", "$ionicAnalytics", function ($log, $rootScope, $ionicBackdrop, $timeout, User, $window, $mdUtil, $mdSidenav, $state, Auth, $mdDialog, $ionicUser, $ionicPush, $ionicAnalytics) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (ngModule) {
	  ...
	  ngModule.directive('sideNavLayout', ["$rootScope", "$mdUtil", "$mdSidenav", "$state", function ($rootScope, $mdUtil, $mdSidenav, $state) {
	    return {
	      restrict: 'E',
	      transclude: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Promise = __webpack_require__(28)['default'];
	...
	module.exports = function (ngModule) {
	  ...
	  function HomeCtrl($scope, User, _, currentAuth, $firebaseObject, Modal, $window, $mdToast, $rootScope, $q) {
	    ...
	    User.get().then(function (user) {
	      ...
	      var t = new _Promise(function (resolve) {
	        setTimeout(resolve, 5000);
	      });

	      _Promise.race([p, t]).then(function () {
	        $rootScope.isLoading = false;
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCE){
	  __webpack_require__(51)(Constructor, NAME, next);
	  ...
	  // Fix native
	  if(_native){
	    var IteratorPrototype = __webpack_require__(42).getProto(_default.call(new Base));
	    // Set @@toStringTag to native iterators
	    __webpack_require__(52)(IteratorPrototype, TAG, true);
	    // FF fix
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(Constructor, NAME, next){
	  ...
	  __webpack_require__(52)(Constructor, NAME + ' Iterator');
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var setUnscope = __webpack_require__(55)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $          = __webpack_require__(42)
	  ...
	  , strictNew  = __webpack_require__(66)
	  ...
	  , RECORD     = __webpack_require__(49)('record')
	...
	species(P);
	species(Wrapper = __webpack_require__(39)[PROMISE]);
	...
	$def($def.S + $def.F * !(useNative && __webpack_require__(81)(function(iter){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getDesc  = __webpack_require__(42).getDesc
	  , isObject = __webpack_require__(64)
	  , anObject = __webpack_require__(65);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (angular) {
	  ...
	  // load module components
	  __webpack_require__(103)(ngModule);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (angular) {
	  ...
	  var ngModule = angular.module('councils.login', []).config(["$stateProvider", function ($stateProvider) {
	    ...
	    $templateCache.put('ldsLogin.html', __webpack_require__(108));
	    $templateCache.put('signup.html', __webpack_require__(109));
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (ngModule) {
	  ...
	  function LoginCtrl($log, $state, Auth, $http, $firebaseObject) {
	    var login = this;
	    login.logoURL = __webpack_require__(111);
	    login.credentials = {};
	    login.lds = {};
