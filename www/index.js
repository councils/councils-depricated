...
/***/ function(module, exports, __webpack_require__) {
	...
	'ionic.service.analytics', 'ngCordova', __webpack_require__(7)(angular).name, __webpack_require__(11)(angular).name, __webpack_require__(18)(angular).name, __webpack_require__(23)(angular).name, __webpack_require__(82)(angular).name, __webpack_require__(87)(angular).name, __webpack_require__(92)(angular).name, __webpack_require__(99)(angular).name, __webpack_require__(104)(angular).name, __webpack_require__(109)(angular).name]).constant('version', __webpack_require__(117).version).constant('_', __webpack_require__(118)).constant('PLATFORM', window.device ? device.platform : 'dev').config(["$compileProvider", "$urlRouterProvider", "$mdThemingProvider", "$ionicAppProvider", function ($compileProvider, $urlRouterProvider, $mdThemingProvider, $ionicAppProvider) {
