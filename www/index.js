...
})(this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_118__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	'ionic.service.analytics', 'ngCordova', __webpack_require__(7)(angular).name, __webpack_require__(11)(angular).name, __webpack_require__(18)(angular).name, __webpack_require__(23)(angular).name, __webpack_require__(82)(angular).name, __webpack_require__(87)(angular).name, __webpack_require__(92)(angular).name, __webpack_require__(99)(angular).name, __webpack_require__(104)(angular).name, __webpack_require__(109)(angular).name]).constant('version', __webpack_require__(117).version).constant('_', __webpack_require__(118)).config(["$compileProvider", "$urlRouterProvider", "$mdThemingProvider", "$ionicAppProvider", function ($compileProvider, $urlRouterProvider, $mdThemingProvider, $ionicAppProvider) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (angular) {
	  ...
	  var ngModule = angular.module('councils.login', []).config(["$stateProvider", function ($stateProvider) {
	    ...
	    $templateCache.put('ldsLogin.html', __webpack_require__(113));
	    $templateCache.put('signup.html', __webpack_require__(114));
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (ngModule) {
	  ...
	  function LoginCtrl($log, $state, Auth, $http, $firebaseObject) {
	    var login = this;
	    login.logoURL = __webpack_require__(116);
	    login.credentials = {};
	    login.lds = {};
